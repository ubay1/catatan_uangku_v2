...
import { Button, Colors, Divider, Menu, Provider, TextInput } from 'react-native-paper';
      ...
      <ScrollView style={{marginHorizontal: 10, marginBottom: 0}}>
        ...
        <View style={{marginTop: 20}}>
          ...
          {/* <DropDown
            ...
            mode={'outlined'}
            value={selectAkun}
            setValue={setselectAkun}
            list={akunList}
            visible={showDropDownKategori}
            showDropDown={() => setShowDropDownKategori(true)}
            onDismiss={() => setShowDropDownKategori(false)}
            inputProps={{
              theme: {colors: {background: Colors.white, placeholder: Colors.grey600,}},
        ...
        <View style={{ marginTop: 20 }}>
          ...
          {/* <DropDown
            ...
            setValue={setselectKategori}
            list={kategoriList}
            visible={showDropDownSaldo}
            showDropDown={() => setShowDropDownSaldo(true)}
            onDismiss={() => setShowDropDownSaldo(false)}
            inputProps={{
              theme: {colors: {background: Colors.white, placeholder: Colors.grey600,}},
              right: <TextInput.Icon name={'menu-down'} />,
            }}
